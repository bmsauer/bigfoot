...
package mpv_client_h is

   --  arg-macro: function MPV_MAKE_VERSION (major, minor)
   --    return ((major) << 16) or (minor) or 0;
   --  unsupported macro: MPV_CLIENT_API_VERSION MPV_MAKE_VERSION(1, 108)
   MPV_ENABLE_DEPRECATED : constant := 1;  --  include_c/client.h:244
  ...
  --  
   ...
   function mpv_client_api_version return unsigned_long;  -- include_c/client.h:250
   pragma Import (C, mpv_client_api_version, "mpv_client_api_version");
  ...
  --  
   ...
   --  skipped empty struct mpv_handle
  ...
  --  
   ...
   subtype mpv_error is unsigned;
   MPV_ERROR_SUCCESS : constant mpv_error := 0;
   MPV_ERROR_EVENT_QUEUE_FULL : constant mpv_error := -1;
   MPV_ERROR_NOMEM : constant mpv_error := -2;
   MPV_ERROR_UNINITIALIZED : constant mpv_error := -3;
   MPV_ERROR_INVALID_PARAMETER : constant mpv_error := -4;
   MPV_ERROR_OPTION_NOT_FOUND : constant mpv_error := -5;
   MPV_ERROR_OPTION_FORMAT : constant mpv_error := -6;
   MPV_ERROR_OPTION_ERROR : constant mpv_error := -7;
   MPV_ERROR_PROPERTY_NOT_FOUND : constant mpv_error := -8;
   MPV_ERROR_PROPERTY_FORMAT : constant mpv_error := -9;
   MPV_ERROR_PROPERTY_UNAVAILABLE : constant mpv_error := -10;
   MPV_ERROR_PROPERTY_ERROR : constant mpv_error := -11;
   MPV_ERROR_COMMAND : constant mpv_error := -12;
   MPV_ERROR_LOADING_FAILED : constant mpv_error := -13;
   MPV_ERROR_AO_INIT_FAILED : constant mpv_error := -14;
   MPV_ERROR_VO_INIT_FAILED : constant mpv_error := -15;
   MPV_ERROR_NOTHING_TO_PLAY : constant mpv_error := -16;
   MPV_ERROR_UNKNOWN_FORMAT : constant mpv_error := -17;
   MPV_ERROR_UNSUPPORTED : constant mpv_error := -18;
   MPV_ERROR_NOT_IMPLEMENTED : constant mpv_error := -19;
   MPV_ERROR_GENERIC : constant mpv_error := -20;  -- include_c/client.h:262
  ...
  --  
   ...
   function mpv_error_string (error : int) return Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:374
   pragma Import (C, mpv_error_string, "mpv_error_string");
  ...
  --  
   ...
   procedure mpv_free (data : System.Address);  -- include_c/client.h:383
   pragma Import (C, mpv_free, "mpv_free");
  ...
  --  
   ...
   function mpv_client_name (ctx : System.Address) return Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:392
   pragma Import (C, mpv_client_name, "mpv_client_name");
  ...
  --  
   ...
   function mpv_client_id (ctx : System.Address) return x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:410
   pragma Import (C, mpv_client_id, "mpv_client_id");
  ...
  --  
   ...
   function mpv_create return System.Address;  -- include_c/client.h:466
   pragma Import (C, mpv_create, "mpv_create");
  ...
  --  
   ...
   function mpv_initialize (ctx : System.Address) return int;  -- include_c/client.h:488
   pragma Import (C, mpv_initialize, "mpv_initialize");
  ...
  --  
   ...
   procedure mpv_destroy (ctx : System.Address);  -- include_c/client.h:500
   pragma Import (C, mpv_destroy, "mpv_destroy");
  ...
  --  
   ...
   procedure mpv_detach_destroy (ctx : System.Address);  -- include_c/client.h:519
   pragma Import (C, mpv_detach_destroy, "mpv_detach_destroy");
  ...
  --  
   ...
   procedure mpv_terminate_destroy (ctx : System.Address);  -- include_c/client.h:547
   pragma Import (C, mpv_terminate_destroy, "mpv_terminate_destroy");
  ...
  --  
   ...
   function mpv_create_client (ctx : System.Address; name : Interfaces.C.Strings.chars_ptr) return System.Address;  -- include_c/client.h:573
   pragma Import (C, mpv_create_client, "mpv_create_client");
  ...
  --  
   ...
   function mpv_create_weak_client (ctx : System.Address; name : Interfaces.C.Strings.chars_ptr) return System.Address;  -- include_c/client.h:587
   pragma Import (C, mpv_create_weak_client, "mpv_create_weak_client");
  ...
  --  
   ...
   function mpv_load_config_file (ctx : System.Address; filename : Interfaces.C.Strings.chars_ptr) return int;  -- include_c/client.h:607
   pragma Import (C, mpv_load_config_file, "mpv_load_config_file");
  ...
  --  
   ...
   procedure mpv_suspend (ctx : System.Address);  -- include_c/client.h:637
   pragma Import (C, mpv_suspend, "mpv_suspend");

  --*
  -- * See mpv_suspend().
  --  

   procedure mpv_resume (ctx : System.Address);  -- include_c/client.h:642
   pragma Import (C, mpv_resume, "mpv_resume");
  ...
  --  
   ...
   function mpv_get_time_us (ctx : System.Address) return x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:660
   pragma Import (C, mpv_get_time_us, "mpv_get_time_us");
  ...
  --  
   ...
   pragma Convention (C, mpv_format);  -- include_c/client.h:667
  ...
  --          
   ...
   type anon_2 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            string : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:804
         when 1 =>
            flag : aliased int;  -- include_c/client.h:805
         when 2 =>
            int64 : aliased x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:806
         when 3 =>
            double_u : aliased double;  -- include_c/client.h:807
         when 4 =>
            list : access mpv_node_list;  -- include_c/client.h:812
         when others =>
            ba : access mpv_byte_array;  -- include_c/client.h:816
      end case;
   end record;
   pragma Convention (C_Pass_By_Copy, anon_2);
   pragma Unchecked_Union (anon_2);type mpv_node is record
      u : aliased anon_2;  -- include_c/client.h:817
      format : aliased mpv_format;  -- include_c/client.h:835
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_node);  -- include_c/client.h:802
  ...
  --      
   ...
   type mpv_node_list is record
      num : aliased int;  -- include_c/client.h:845
      values : access mpv_node;  -- include_c/client.h:856
      keys : System.Address;  -- include_c/client.h:867
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_node_list);  -- include_c/client.h:841
  ...
  --      
   ...
   type mpv_byte_array is record
      data : System.Address;  -- include_c/client.h:878
      size : aliased stddef_h.size_t;  -- include_c/client.h:882
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_byte_array);  -- include_c/client.h:873
  ...
  --  
   ...
   procedure mpv_free_node_contents (node : access mpv_node);  -- include_c/client.h:895
   pragma Import (C, mpv_free_node_contents, "mpv_free_node_contents");
  ...
  --  
   ...
   function mpv_set_option
     (ctx : System.Address;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format;
      data : System.Address) return int;  -- include_c/client.h:938
   pragma Import (C, mpv_set_option, "mpv_set_option");
  ...
  --  
   ...
   function mpv_set_option_string
     (ctx : System.Address;
      name : Interfaces.C.Strings.chars_ptr;
      data : Interfaces.C.Strings.chars_ptr) return int;  -- include_c/client.h:947
   pragma Import (C, mpv_set_option_string, "mpv_set_option_string");
  ...
  --  
   ...
   function mpv_command (ctx : System.Address; args : System.Address) return int;  -- include_c/client.h:963
   pragma Import (C, mpv_command, "mpv_command");
  ...
  --  
   ...
   function mpv_command_node
     (ctx : System.Address;
      args : access mpv_node;
      result : access mpv_node) return int;  -- include_c/client.h:999
   pragma Import (C, mpv_command_node, "mpv_command_node");
  ...
  --  
   ...
   function mpv_command_ret
     (ctx : System.Address;
      args : System.Address;
      result : access mpv_node) return int;  -- include_c/client.h:1015
   pragma Import (C, mpv_command_ret, "mpv_command_ret");
  ...
  --  
   ...
   function mpv_command_string (ctx : System.Address; args : Interfaces.C.Strings.chars_ptr) return int;  -- include_c/client.h:1024
   pragma Import (C, mpv_command_string, "mpv_command_string");
  ...
  --  
   ...
   function mpv_command_async
     (ctx : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      args : System.Address) return int;  -- include_c/client.h:1046
   pragma Import (C, mpv_command_async, "mpv_command_async");
  ...
  --  
   ...
   function mpv_command_node_async
     (ctx : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      args : access mpv_node) return int;  -- include_c/client.h:1063
   pragma Import (C, mpv_command_node_async, "mpv_command_node_async");
  ...
  --  
   ...
   procedure mpv_abort_async_command (ctx : System.Address; reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t);  -- include_c/client.h:1096
   pragma Import (C, mpv_abort_async_command, "mpv_abort_async_command");
  ...
  --  
   ...
   function mpv_set_property
     (ctx : System.Address;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format;
      data : System.Address) return int;  -- include_c/client.h:1129
   pragma Import (C, mpv_set_property, "mpv_set_property");
  ...
  --  
   ...
   function mpv_set_property_string
     (ctx : System.Address;
      name : Interfaces.C.Strings.chars_ptr;
      data : Interfaces.C.Strings.chars_ptr) return int;  -- include_c/client.h:1137
   pragma Import (C, mpv_set_property_string, "mpv_set_property_string");
  ...
  --  
   ...
   function mpv_set_property_async
     (ctx : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format;
      data : System.Address) return int;  -- include_c/client.h:1154
   pragma Import (C, mpv_set_property_async, "mpv_set_property_async");
  ...
  --  
   ...
   function mpv_get_property
     (ctx : System.Address;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format;
      data : System.Address) return int;  -- include_c/client.h:1175
   pragma Import (C, mpv_get_property, "mpv_get_property");
  ...
  --  
   ...
   function mpv_get_property_string (ctx : System.Address; name : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1191
   pragma Import (C, mpv_get_property_string, "mpv_get_property_string");
  ...
  --  
   ...
   function mpv_get_property_osd_string (ctx : System.Address; name : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1200
   pragma Import (C, mpv_get_property_osd_string, "mpv_get_property_osd_string");
  ...
  --  
   ...
   function mpv_get_property_async
     (ctx : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format) return int;  -- include_c/client.h:1214
   pragma Import (C, mpv_get_property_async, "mpv_get_property_async");
  ...
  --  
   ...
   function mpv_observe_property
     (mpv : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      name : Interfaces.C.Strings.chars_ptr;
      format : mpv_format) return int;  -- include_c/client.h:1272
   pragma Import (C, mpv_observe_property, "mpv_observe_property");
  ...
  --  
   ...
   function mpv_unobserve_property (mpv : System.Address; registered_reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t) return int;  -- include_c/client.h:1285
   pragma Import (C, mpv_unobserve_property, "mpv_unobserve_property");

   type mpv_event_id is 
     (MPV_EVENT_NONE_ID,
      MPV_EVENT_SHUTDOWN_ID,
      MPV_EVENT_LOG_MESSAGE_ID,
      MPV_EVENT_GET_PROPERTY_REPLY_ID,
      MPV_EVENT_SET_PROPERTY_REPLY_ID,
      MPV_EVENT_COMMAND_REPLY_ID,
      MPV_EVENT_START_FILE_ID,
      MPV_EVENT_END_FILE_ID,
      MPV_EVENT_FILE_LOADED_ID,
      MPV_EVENT_TRACKS_CHANGED_ID,
      MPV_EVENT_TRACK_SWITCHED_ID,
      MPV_EVENT_IDLE_ID,
      MPV_EVENT_PAUSE_ID,
      MPV_EVENT_UNPAUSE_ID,
      MPV_EVENT_TICK_ID,
      MPV_EVENT_SCRIPT_INPUT_DISPATCH_ID,
      MPV_EVENT_CLIENT_MESSAGE_ID,
      MPV_EVENT_VIDEO_RECONFIG_ID,
      MPV_EVENT_AUDIO_RECONFIG_ID,
      MPV_EVENT_METADATA_UPDATE_ID,
      MPV_EVENT_SEEK_ID,
      MPV_EVENT_PLAYBACK_RESTART_ID,
      MPV_EVENT_PROPERTY_CHANGE_ID,
      MPV_EVENT_CHAPTER_CHANGE_ID,
      MPV_EVENT_QUEUE_OVERFLOW_ID,
      MPV_EVENT_HOOK_ID);
   pragma Convention (C, mpv_event_id);  -- include_c/client.h:1287
  ...
  --  
   ...
   function mpv_event_name (event : mpv_event_id) return Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1511
   pragma Import (C, mpv_event_name, "mpv_event_name");

  --*
  --     * Name of the property.
  --      

   type mpv_event_property is record
      name : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1517
      format : aliased mpv_format;  -- include_c/client.h:1524
      data : System.Address;  -- include_c/client.h:1536
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_property);  -- include_c/client.h:1513
  ...
  --  
   ...
   subtype mpv_log_level is unsigned;
   MPV_LOG_LEVEL_NONE : constant mpv_log_level := 0;
   MPV_LOG_LEVEL_FATAL : constant mpv_log_level := 10;
   MPV_LOG_LEVEL_ERROR : constant mpv_log_level := 20;
   MPV_LOG_LEVEL_WARN : constant mpv_log_level := 30;
   MPV_LOG_LEVEL_INFO : constant mpv_log_level := 40;
   MPV_LOG_LEVEL_V : constant mpv_log_level := 50;
   MPV_LOG_LEVEL_DEBUG : constant mpv_log_level := 60;
   MPV_LOG_LEVEL_TRACE : constant mpv_log_level := 70;  -- include_c/client.h:1546
  ...
  --      
   ...
   type mpv_event_log_message is record
      prefix : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1564
      level : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1569
      text : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1575
      log_level : aliased mpv_log_level;  -- include_c/client.h:1580
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_log_message);  -- include_c/client.h:1557
  ...
  --/ Since API version 1.9.
   subtype mpv_end_file_reason is unsigned;
   MPV_END_FILE_REASON_EOF : constant mpv_end_file_reason := 0;
   MPV_END_FILE_REASON_STOP : constant mpv_end_file_reason := 2;
   MPV_END_FILE_REASON_QUIT : constant mpv_end_file_reason := 3;
   MPV_END_FILE_REASON_ERROR : constant mpv_end_file_reason := 4;
   MPV_END_FILE_REASON_REDIRECT : constant mpv_end_file_reason := 5;  -- include_c/client.h:1584
  ...
  --      
   ...
   type mpv_event_start_file is record
      playlist_entry_id : aliased x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:1624
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_start_file);  -- include_c/client.h:1620
  ...
  --      
   ...
   type mpv_event_end_file is record
      reason : aliased int;  -- include_c/client.h:1634
      error : aliased int;  -- include_c/client.h:1641
      playlist_entry_id : aliased x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:1648
      playlist_insert_id : aliased x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- include_c/client.h:1663
      playlist_insert_num_entries : aliased int;  -- include_c/client.h:1669
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_end_file);  -- include_c/client.h:1627
  ...
  --  
   ...
   type mpv_event_script_input_dispatch is record
      arg0 : aliased int;  -- include_c/client.h:1676
      c_type : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1677
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_script_input_dispatch);  -- include_c/client.h:1675
  ...
  --      
   ...
   type mpv_event_client_message is record
      num_args : aliased int;  -- include_c/client.h:1688
      args : System.Address;  -- include_c/client.h:1689
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_client_message);  -- include_c/client.h:1681

  --*
  --     * The hook name as passed to mpv_hook_add().
  --      

   type mpv_event_hook is record
      name : Interfaces.C.Strings.chars_ptr;  -- include_c/client.h:1696
      id : aliased x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;  -- include_c/client.h:1700
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_hook);  -- include_c/client.h:1692
  ...
  --      
   ...
   type mpv_event_command is record
      result : aliased mpv_node;  -- include_c/client.h:1711
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event_command);  -- include_c/client.h:1704
  ...
  --      
   ...
   type mpv_event is record
      event_id : aliased mpv_event_id;  -- include_c/client.h:1719
      error : aliased int;  -- include_c/client.h:1730
      reply_userdata : aliased x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;  -- include_c/client.h:1742
      data : System.Address;  -- include_c/client.h:1758
   end record;
   pragma Convention (C_Pass_By_Copy, mpv_event);  -- include_c/client.h:1714
  ...
  --  
   ...
   function mpv_event_to_node (dst : access mpv_node; src : access mpv_event) return int;  -- include_c/client.h:1784
   pragma Import (C, mpv_event_to_node, "mpv_event_to_node");
  ...
  --  
   ...
   function mpv_request_event
     (ctx : System.Address;
      event : mpv_event_id;
      enable : int) return int;  -- include_c/client.h:1800
   pragma Import (C, mpv_request_event, "mpv_request_event");
  ...
  --  
   ...
   function mpv_request_log_messages (ctx : System.Address; min_level : Interfaces.C.Strings.chars_ptr) return int;  -- include_c/client.h:1816
   pragma Import (C, mpv_request_log_messages, "mpv_request_log_messages");
  ...
  --  
   ...
   function mpv_wait_event (ctx : System.Address; timeout : double) return access mpv_event;  -- include_c/client.h:1849
   pragma Import (C, mpv_wait_event, "mpv_wait_event");
  ...
  --  
   ...
   procedure mpv_wakeup (ctx : System.Address);  -- include_c/client.h:1864
   pragma Import (C, mpv_wakeup, "mpv_wakeup");
  ...
  --  
   ...
   procedure mpv_set_wakeup_callback
     (ctx : System.Address;
      cb : access procedure (arg1 : System.Address);
      d : System.Address);  -- include_c/client.h:1902
   pragma Import (C, mpv_set_wakeup_callback, "mpv_set_wakeup_callback");
  ...
  --  
   ...
   procedure mpv_wait_async_requests (ctx : System.Address);  -- include_c/client.h:1916
   pragma Import (C, mpv_wait_async_requests, "mpv_wait_async_requests");
  ...
  --  
   ...
   function mpv_hook_add
     (ctx : System.Address;
      reply_userdata : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;
      name : Interfaces.C.Strings.chars_ptr;
      priority : int) return int;  -- include_c/client.h:1953
   pragma Import (C, mpv_hook_add, "mpv_hook_add");
  ...
  --  
   ...
   function mpv_hook_continue (ctx : System.Address; id : x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t) return int;  -- include_c/client.h:1972
   pragma Import (C, mpv_hook_continue, "mpv_hook_continue");
  ...
  --  
   ...
   function mpv_get_wakeup_pipe (ctx : System.Address) return int;  -- include_c/client.h:2034
   pragma Import (C, mpv_get_wakeup_pipe, "mpv_get_wakeup_pipe");

  --*
  -- * @deprecated use render.h
  --  

   subtype mpv_sub_api is unsigned;
   MPV_SUB_API_OPENGL_CB : constant mpv_sub_api := 1;  -- include_c/client.h:2039
  ...
  --  
   ...
   function mpv_get_sub_api (ctx : System.Address; sub_api : mpv_sub_api) return System.Address;  -- include_c/client.h:2058
   pragma Import (C, mpv_get_sub_api, "mpv_get_sub_api");
